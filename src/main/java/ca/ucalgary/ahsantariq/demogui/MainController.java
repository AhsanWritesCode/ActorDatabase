...
public class MainController {
    ...
    public void about(ActionEvent actionEvent) {
        ...
        Alert about = new Alert(Alert.AlertType.INFORMATION, "Author: Rahnuha Nurain,Ahsan Tariq, Ethan Braum  \n Email: rahnuha.nurain@ucalgary.ca,ahsan.tariq@ucalgary.ca,ethan.braum@ucalgary.ca nVersion: v1.0\nThis is" +
