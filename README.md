# Group Project With GUI

## Description

Our group's project is a database for actors similar to IMDB. It takes in information about actors from the user (name, age, height, etc.) and displays it in a clean, consistent monospaced font. It also displays any co-star pairs   

## Integrate with your tools

- [ ] [Set up project integrations](https://csgit.ucalgary.ca/ahsan.tariq/groupprojectgui/-/settings/integrations)
